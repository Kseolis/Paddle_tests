...
import static im.mak.paddle.blockchain_updates.subscribe_invoke_tx_tests.invoke_transactions_checkers.InvokeMetadataAssertions.checkMainMetadata;
import static im.mak.paddle.blockchain_updates.subscribe_invoke_tx_tests.invoke_transactions_checkers.InvokeMetadataAssertions.checkPaymentMetadata;
...
import static im.mak.paddle.blockchain_updates.subscribe_invoke_tx_tests.invoke_transactions_checkers.InvokeTransactionAssertions.*;
...
public class SubscribeInvokeLeaseCancelTest extends SubscribeInvokeBaseTest {
    @Test
    ...
    void subscribeInvokeWithLeaseCancel() {
        ...
        prepareDataForLeaseCancelTests();
