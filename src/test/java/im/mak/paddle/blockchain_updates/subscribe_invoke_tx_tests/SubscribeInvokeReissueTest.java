...
import im.mak.paddle.blockchain_updates.subscribe_invoke_tx_tests.invoke_transactions_checkers.InvokeTransactionAssertions;
...
import static im.mak.paddle.blockchain_updates.subscribe_invoke_tx_tests.invoke_transactions_checkers.InvokeStateUpdateAssertions.checkStateUpdateAssets;
...
public class SubscribeInvokeReissueTest extends SubscribeInvokeBaseTest {
    @Test
    @DisplayName("subscribe invoke with Reissue")
    void subscribeInvokeWithReissue() {
        prepareDataForReissueTests();
        ...
        InvokeTransactionAssertions.checkInvokeSubscribeTransaction(getInvokeFee(), getCallerPublicKey());
        assertionsCheck();
    }
