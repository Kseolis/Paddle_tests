...
import static im.mak.paddle.blockchain_updates.subscribe_invoke_tx_tests.invoke_transactions_checkers.InvokeMetadataAssertions.checkIssueAssetMetadata;
...
public class SubscribeInvokeScriptTransferTest extends SubscribeInvokeBaseTest {
    @Test
    ...
    void subscribeInvokeWithScriptTransfer() {
        ...
        prepareDataForScriptTransferTests();
