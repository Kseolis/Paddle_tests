...
import static im.mak.paddle.helpers.blockchain_updates_handlers.subscribe_handlers.invoke_transaction_metadata.InvokeMetadataResultLease.*;
...
public class InvokeTransactionAssertions extends InvokeBaseTest {
    ...
    protected static void checkInvokeSubscribeTransaction(long fee) {
        assertAll(
    ...
    protected static void checkPaymentMetadata(int metadataIndex, int dataIndex, long amount) {
    ...
    protected static void checkLeaseMetadata(int metadataIndex, int dataIndex, String publicKeyHash, long amount) {
        assertAll(
